...
import { useCreateLectureMutation, useGetCourseLectureQuery } from '@/features/api/courseApi.js';
...
const CreateLecture = () => {
    ...
    const { data: lectureData, isLoading: lectureIsLoading ,error:lectureError} = useGetCourseLectureQuery(courseId);
