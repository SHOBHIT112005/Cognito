      ...
      <div className="max-w-7xl mx-auto hidden md:flex justify-between items-center gap-10 h-full">
        <div className="flex items-center gap-2">
          ...
          <h1 className="hidden md:block font-extrabold text-2xl">
            <button onClick={() => (navigate("/"))}>E-Learning</button>
          </h1>
        </div>
    ...
    <Sheet>
      ...
      <SheetContent className="flex flex-col gap-0">
        ...
        <nav className="flex flex-col space-y-4 mx-4">
          ...
          {/* {user.role === "instructor" && <Button type="submit"><Link to="admin/dashboard">Dashboard</Link></Button>}
          {user.role === "instructor" && <Button type="submit"><Link to="admin/course">Courses</Link></Button>} */}
        </nav>
      </SheetContent>
    </Sheet>
  );
